...
export default function(settings) {
    ...
    this.$els = {
        ...
        volumeBtn: this.$container.find('.player__controls .icon-volume2-hold'),
        fullBtn: this.$container.find('.player__controls .icon-fullscreen-hold'),
        fbBtn: this.$container.find('.player__share .icon-vidfacebook'),
        twBtn: this.$container.find('.player__share .icon-vidtwitter'),
        codeBtn: this.$container.find('.player__share .icon-vidshareurl'),
